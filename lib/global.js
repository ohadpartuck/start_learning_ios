...
var Global = {
    ...
    getFiveFacts: function(){
        startLearning.fiveFacts = [{text: 'שנה שעברה, פעלו בישראל מעל 5000 סטארטאפים, השנה - 5900. גידול של 18%!', source: 'http://blogs.microsoft.co.il/msdn/2014/03/27/why-israel-is-the-startup-nation/', date: 123123123123},
    ...
    _setLS: function (key, value, useSessionStorage) {
        ...
        var ls = (useSessionStorage) ? window.sessionStorage : AsyncStorage;
    ...
    _getLS: function (key, parseJson, useSessionStorage) {
        ...
        var ret,
            ls = (useSessionStorage) ? window.sessionStorage : AsyncStorage,
            rs = ls.getItem(key);
